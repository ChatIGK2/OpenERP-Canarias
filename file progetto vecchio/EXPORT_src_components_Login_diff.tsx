--- EXPORT_src_components_Login.tsx (原始)


+++ EXPORT_src_components_Login.tsx (修改后)
    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-emerald-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full animate-scale-in">
        ...
        <div className="text-center mb-8">
          <div className="inline-block p-5 bg-gradient-to-br from-sky-400 to-emerald-400 rounded-3xl shadow-2xl mb-4 animate-pulse-soft">
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl p-8 border border-sky-100">
          ...
          {error && (
            <div className="mb-4 p-4 bg-rose-50 border-2 border-rose-200 rounded-xl animate-scale-in">
              <div className="flex items-center">
                <i className="fas fa-exclamation-circle text-rose-600 mr-2"></i>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <i className="fas fa-user absolute left-4 top-1/2 transform -translate-y-1/2 text-sky-400"></i>
                <input
                  id="username"
                  type="text"
                  value={username}
                  onChange={(e) => setUsername(e.target.value)}
                  className="w-full pl-11 pr-4 py-3 border-2 border-sky-200 rounded-xl focus:border-sky-400 transition-all duration-200"
            ...
            <div>
              ...
              <div className="relative">
                <i className="fas fa-lock absolute left-4 top-1/2 transform -translate-y-1/2 text-sky-400"></i>
                <input
                  id="password"
                  type={showPassword ? 'text' : 'password'}
                  value={password}
                  onChange={(e) => setPassword(e.target.value)}
                  className="w-full pl-11 pr-12 py-3 border-2 border-sky-200 rounded-xl focus:border-sky-400 transition-all duration-200"
        ...
        {/* Credenziali demo */}
        <div className="mt-6 bg-gradient-to-r from-amber-50 to-amber-100 border-2 border-amber-200 rounded-2xl p-4 animate-fade-in">
